...
- **2. Create New Services:** Develop new services or systems using Encore’s [Backend SDK](/docs/primitives) to get off the ground quickly. This lets you try out all Encore features and enables you to design your new system with Encore’s [automatic architecture diagrams](/docs/observability/encore-flow).
...
- **2. Develop from Scratch:** Develop your new application using Encore's [Backend SDK](/docs/primitives) to get up and running quickly in a shared environment using Encore’s built-in development cloud.

...
You can see how to configure and deploy your application in the [self-hosting documentation](/docs/ts/self-host/build), or you can use Encore Cloud Platform to automate infrastructure provisioning. More on that below:
